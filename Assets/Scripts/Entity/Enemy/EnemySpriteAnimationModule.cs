...
namespace Enemy
{
    ...
    public class EnemySpriteAnimationModule
    {
        ...
        public void UpdateAnimation(float deltaTime, Vector2? moveDirection = null)
        {
            ...
            if (moveDirection.HasValue && _data.directionalSprites != null && _data.directionalSprites.Length >= 8)
            {
        ...
        private void UpdateLoopAnimation(float deltaTime)
        {
            ...
            if (_data.defaultFPS <= 0 || _data.animationFrames.Length == 0) return;

...
namespace Weapon
{
    public class WeaponVisuals : MonoBehaviour
    {
        ...
        [SerializeField]
        private Vector3 rightPivotOffset = new Vector3(0.2f, 0.3f, 0f);

        [Tooltip("Offset of the pivot point from the center of the player when aiming left.")]
        [SerializeField]
        private Vector3 leftPivotOffset = new Vector3(-0.2f, 0.3f, 0f);

        [Tooltip(
            "Local offset to align the weapon handle (bottom-left of sprite) to the pivot point."
        )]
        [SerializeField]
        private Vector3 handleOffset = new Vector3(0.2f, 0.2f, 0f);
        ...
        private void HandleOrientation()
        {
            ...
            Vector3 currentHandleOffset = new Vector3(
                handleOffset.x,
                handleOffset.y * scaleY,
                handleOffset.z
            );

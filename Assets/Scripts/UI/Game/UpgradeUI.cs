...
namespace UI
{
    public class UpgradeUI : MonoBehaviour
    {
        ...
        private void BuildUI()
        {
            ...
            _uiCanvas.transform.SetParent(gameObject.transform);
            _uiCanvas.SetActive(false);
        }
        ...
        )
        {
            ...
            if (font == null)
                font = Resources.Load<TMP_FontAsset>("Fonts/Galmuri9");
            if (font != null)
                tmp.font = font;

...
namespace UI.DDA
{
    public class DDAAnalyticsPanel : MonoBehaviour
    {
        ...
        private void BuildLogArea(Transform parent)
        {
            ...
            vpRt.offsetMin = new Vector2(15, 15);
            vpRt.offsetMax = new Vector2(-15, -15);
            ...
            UnityEngine.UI.ContentSizeFitter csf =
                textObj.AddComponent<UnityEngine.UI.ContentSizeFitter>();
        ...
        private void HandleDDACalculated(
            float s,
            float c,
            float alpha,
            int baseBudget,
        ...
        )
        {
            ...
            if (radarChart != null)
                radarChart.UpdateValues(visualApm, visualAcc, visualEva);
            ...
            if (logText != null)
            {
                ...
                if (logText.text.Length > 2500)
                    logText.text = logText.text.Substring(logText.text.Length - 2500);

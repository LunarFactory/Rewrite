...
namespace Level
{
    ...
    public class ExitPortal : InteractableBase
    {
        public override string GetInteractPrompt()
        {
            if (Core.WaveManager.Instance != null && Core.RunManager.Instance != null)
            {
                if (Core.WaveManager.Instance.CurrentWave < 9)
                {
                    ...
                    return $"다음 층 [{Core.RunManager.Instance.CurrentFloor + 1} 층]";
            }
        ...
        private void ClearFieldObjects()
        {
            ...
            FieldItem[] remainingItems = Object.FindObjectsByType<FieldItem>(
            ...
            Healkit[] remainingKits = Object.FindObjectsByType<Healkit>(
                FindObjectsInactive.Exclude
            );

...
namespace Item
{
    ...
    [CreateAssetMenu(fileName = "DroneDefense", menuName = "Items/Common/Drone - Defense")]
    public class DroneDefense : PassiveItemData
    {
        ...
        public override void OnApply(PlayerStats player)
        {
            ...
            if (DroneManager.Instance != null)
            {
                ...
                DroneManager.Instance.UnlockAbility("Defense");
            }
